...
const SEG = 'h-[34px] px-3 rounded-[4px] text-center text-[12.5px] font-semibold transition-colors motion-reduce:transition-none inline-flex items-center justify-center';
...
export default function AgregacoesNav() {
  ...
  return (
    <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 mt-5 flex flex-wrap items-center gap-2.5">
      <div role="group" aria-label="Seções de agregações" className={`${GROUP} grid-cols-2`}>
