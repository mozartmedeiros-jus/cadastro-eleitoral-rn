...
<objetivo_visual>
Direção: dashboard INSTITUCIONAL govtech, tema CLARO como padrão. Paleta azul institucional + cinza neutro. Superfícies planas com borda fina de 1px (SEM glassmorphism, blur ou gradientes pesados). Cantos suaves (~8px). Tipografia forte, com números em destaque por peso/cor. Visual sóbrio e oficial, priorizando legibilidade e densidade de dados. Referência: gov.br / govtech. Manter também uma variante escura coerente.
